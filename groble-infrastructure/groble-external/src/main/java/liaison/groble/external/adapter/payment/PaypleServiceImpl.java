...
//      // 기존 PayDate 필드는 제거되었으므로 현재 날짜 사용
//      refundObj.put(
//          "PCD_PAY_DATE", new java.text.SimpleDateFormat("yyyyMMdd").format(new
// java.util.Date()));
//      refundObj.put("PCD_REFUND_TOTAL", request.getRefundTotal());
//
//      if (request.getRefundTaxfree() != null) {
//        refundObj.put("PCD_REFUND_TAXTOTAL", request.getRefundTaxfree());
//      }
//
