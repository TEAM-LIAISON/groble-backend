...
public class QUserCoupon extends EntityPathBase<UserCoupon> {
  ...
  public final DateTimePath<java.time.LocalDateTime> issuedAt =
      createDateTime("issuedAt", java.time.LocalDateTime.class);

  public final EnumPath<liaison.groble.domain.coupon.enums.CouponStatus> status =
      createEnum("status", liaison.groble.domain.coupon.enums.CouponStatus.class);

  // inherited
  public final DateTimePath<java.time.LocalDateTime> updatedAt = _super.updatedAt;

  public final DateTimePath<java.time.LocalDateTime> usedAt =
      createDateTime("usedAt", java.time.LocalDateTime.class);
  ...
  public QUserCoupon(Class<? extends UserCoupon> type, PathMetadata metadata, PathInits inits) {
    ...
    this.couponTemplate =
        inits.isInitialized("couponTemplate")
            ? new QCouponTemplate(forProperty("couponTemplate"))
            : null;
    this.user =
