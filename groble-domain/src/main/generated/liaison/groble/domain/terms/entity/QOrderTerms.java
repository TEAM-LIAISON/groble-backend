...
public class QOrderTerms extends EntityPathBase<OrderTerms> {
    ...
    public final ListPath<UserOrderTerms, QUserOrderTerms> agreements = this.<UserOrderTerms, QUserOrderTerms>createList("agreements", UserOrderTerms.class, QUserOrderTerms.class, PathInits.DIRECT2);
    ...
    public final EnumPath<liaison.groble.domain.terms.enums.OrderTermsType> type = createEnum("type", liaison.groble.domain.terms.enums.OrderTermsType.class);
