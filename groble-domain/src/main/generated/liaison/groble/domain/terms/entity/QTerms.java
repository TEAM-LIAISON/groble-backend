...
public class QTerms extends EntityPathBase<Terms> {
    ...
    private static final long serialVersionUID = -1988708969L;

    public static final QTerms terms = new QTerms("terms");

    public final ListPath<UserTerms, QUserTerms> agreements = this.<UserTerms, QUserTerms>createList("agreements", UserTerms.class, QUserTerms.class, PathInits.DIRECT2);
    ...
    public final EnumPath<liaison.groble.domain.terms.enums.TermsType> type = createEnum("type", liaison.groble.domain.terms.enums.TermsType.class);
