...
public class QGuestUserOrderTerms extends EntityPathBase<GuestUserOrderTerms> {
  ...
  public static final QGuestUserOrderTerms guestUserOrderTerms =
      new QGuestUserOrderTerms("guestUserOrderTerms");
  ...
  public QGuestUserOrderTerms(
      Class<? extends GuestUserOrderTerms> type, PathMetadata metadata, PathInits inits) {
    ...
    this.guestUser =
        inits.isInitialized("guestUser")
            ...
            : null;
    this.orderTerms =
        inits.isInitialized("orderTerms") ? new QOrderTerms(forProperty("orderTerms")) : null;
  }
}
