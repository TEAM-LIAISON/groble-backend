...
public class QReferrerTracking extends EntityPathBase<ReferrerTracking> {
  ...
  public static final QReferrerTracking referrerTracking =
      new QReferrerTracking("referrerTracking");
  ...
  public final DateTimePath<java.time.LocalDateTime> eventTimestamp =
      createDateTime("eventTimestamp", java.time.LocalDateTime.class);
