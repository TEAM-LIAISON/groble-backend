...
public class QPurchase extends EntityPathBase<Purchase> {
  ...
  public final EnumPath<liaison.groble.domain.purchase.enums.CancelReason> cancelReason =
      createEnum("cancelReason", liaison.groble.domain.purchase.enums.CancelReason.class);

  public final DateTimePath<java.time.LocalDateTime> cancelRequestedAt =
      createDateTime("cancelRequestedAt", java.time.LocalDateTime.class);
  ...
  public final EnumPath<Purchase.OptionType> selectedOptionType =
      createEnum("selectedOptionType", Purchase.OptionType.class);
  ...
  public QPurchase(Class<? extends Purchase> type, PathMetadata metadata, PathInits inits) {
    ...
    this.payment =
        inits.isInitialized("payment")
            ...
            : null;
    this.usedCoupon =
        inits.isInitialized("usedCoupon")
            ? new liaison.groble.domain.coupon.entity.QUserCoupon(
                forProperty("usedCoupon"), inits.get("usedCoupon"))
            : null;
    this.user =
