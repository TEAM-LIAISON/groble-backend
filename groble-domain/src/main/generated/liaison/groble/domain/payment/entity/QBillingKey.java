...
public class QBillingKey extends EntityPathBase<BillingKey> {
  ...
  public final DateTimePath<java.time.LocalDateTime> lastUsedAt =
      createDateTime("lastUsedAt", java.time.LocalDateTime.class);

  public final EnumPath<liaison.groble.domain.payment.enums.BillingKeyStatus> status =
      createEnum("status", liaison.groble.domain.payment.enums.BillingKeyStatus.class);
