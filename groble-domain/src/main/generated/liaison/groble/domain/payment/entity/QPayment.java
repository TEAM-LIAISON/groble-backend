...
public class QPayment extends EntityPathBase<Payment> {
  ...
  public final DateTimePath<java.time.LocalDateTime> cancelAt =
      createDateTime("cancelAt", java.time.LocalDateTime.class);

  public final ListPath<PaymentCancel, QPaymentCancel> cancellations =
      this.<PaymentCancel, QPaymentCancel>createList(
          "cancellations", PaymentCancel.class, QPaymentCancel.class, PathInits.DIRECT2);
  ...
  public final ListPath<PaymentLog, QPaymentLog> logs =
      this.<PaymentLog, QPaymentLog>createList(
          "logs", PaymentLog.class, QPaymentLog.class, PathInits.DIRECT2);
  ...
  public final EnumPath<Payment.PaymentMethod> paymentMethod =
      createEnum("paymentMethod", Payment.PaymentMethod.class);

  public final EnumPath<Payment.PgProvider> pgProvider =
      createEnum("pgProvider", Payment.PgProvider.class);
  ...
  public final MapPath<String, Object, SimplePath<Object>> requestParams =
      this.<String, Object, SimplePath<Object>>createMap(
          "requestParams", String.class, Object.class, SimplePath.class);

  public final MapPath<String, Object, SimplePath<Object>> responseParams =
      this.<String, Object, SimplePath<Object>>createMap(
          "responseParams", String.class, Object.class, SimplePath.class);

  public final NumberPath<Long> selectedOptionId = createNumber("selectedOptionId", Long.class);

  public final EnumPath<Payment.SelectedOptionType> selectedOptionType =
      createEnum("selectedOptionType", Payment.SelectedOptionType.class);

  public final EnumPath<Payment.PaymentStatus> status =
      createEnum("status", Payment.PaymentStatus.class);
  ...
  public final DateTimePath<java.time.LocalDateTime> virtualAccountExpiryDate =
      createDateTime("virtualAccountExpiryDate", java.time.LocalDateTime.class);
