...
public class QGuestUser extends EntityPathBase<GuestUser> {
    ...
    public final EnumPath<liaison.groble.domain.guest.enums.PhoneVerificationStatus> phoneVerificationStatus = createEnum("phoneVerificationStatus", liaison.groble.domain.guest.enums.PhoneVerificationStatus.class);
