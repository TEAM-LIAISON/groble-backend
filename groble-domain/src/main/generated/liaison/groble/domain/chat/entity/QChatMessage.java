...
public class QChatMessage extends EntityPathBase<ChatMessage> {
  ...
  private static final long serialVersionUID = 1025831366L;
  ...
  public final liaison.groble.domain.user.entity.QUser sender;
  ...
  public QChatMessage(Class<? extends ChatMessage> type, PathMetadata metadata, PathInits inits) {
    ...
    this.chatRoom =
        inits.isInitialized("chatRoom")
            ? new QChatRoom(forProperty("chatRoom"), inits.get("chatRoom"))
            : null;
    this.sender =
        inits.isInitialized("sender")
            ? new liaison.groble.domain.user.entity.QUser(
                forProperty("sender"), inits.get("sender"))
            : null;
  }
}
