...
public class QChatRoom extends EntityPathBase<ChatRoom> {
    ...
    public final NumberPath<Integer> buyerUnreadCount = createNumber("buyerUnreadCount", Integer.class);
    ...
    public final NumberPath<Integer> sellerUnreadCount = createNumber("sellerUnreadCount", Integer.class);
    ...
    public QChatRoom(Class<? extends ChatRoom> type, PathMetadata metadata, PathInits inits) {
        ...
        this.buyer = inits.isInitialized("buyer") ? new liaison.groble.domain.user.entity.QUser(forProperty("buyer"), inits.get("buyer")) : null;
