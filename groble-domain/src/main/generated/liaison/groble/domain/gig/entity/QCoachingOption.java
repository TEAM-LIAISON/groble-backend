...
public class QCoachingOption extends EntityPathBase<CoachingOption> {
  ...
  private static final long serialVersionUID = 2070519883L;

  private static final PathInits INITS = PathInits.DIRECT2;

  public static final QCoachingOption coachingOption = new QCoachingOption("coachingOption");

  public final QGigOption _super;

  public final EnumPath<liaison.groble.domain.gig.enums.CoachingPeriod> coachingPeriod =
      createEnum("coachingPeriod", liaison.groble.domain.gig.enums.CoachingPeriod.class);

  public final EnumPath<liaison.groble.domain.gig.enums.CoachingType> coachingType =
      createEnum("coachingType", liaison.groble.domain.gig.enums.CoachingType.class);
  ...
  public final EnumPath<liaison.groble.domain.gig.enums.DocumentProvision> documentProvision =
      createEnum("documentProvision", liaison.groble.domain.gig.enums.DocumentProvision.class);
  ...
  public QCoachingOption(
    ...
    this._super = new QGigOption(type, metadata, inits);
