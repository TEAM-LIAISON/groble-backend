...
public class QGig extends EntityPathBase<Gig> {
  ...
  public final EnumPath<liaison.groble.domain.gig.enums.GigType> gigType =
      createEnum("gigType", liaison.groble.domain.gig.enums.GigType.class);

  public final NumberPath<Long> id = createNumber("id", Long.class);

  public final ListPath<GigOption, QGigOption> options =
      this.<GigOption, QGigOption>createList(
          "options", GigOption.class, QGigOption.class, PathInits.DIRECT2);

  public final NumberPath<Integer> saleCount = createNumber("saleCount", Integer.class);

  public final EnumPath<liaison.groble.domain.gig.enums.GigStatus> status =
      createEnum("status", liaison.groble.domain.gig.enums.GigStatus.class);
