...
public class QCategory extends EntityPathBase<Category> {
    ...
    private static final long serialVersionUID = -807572768L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QCategory category = new QCategory("category");

    public final EnumPath<liaison.groble.domain.content.enums.ContentType> categoryType = createEnum("categoryType", liaison.groble.domain.content.enums.ContentType.class);
