...
public class QContentReview extends EntityPathBase<ContentReview> {
  ...
  public final DateTimePath<java.time.LocalDateTime> deletionRequestedAt =
      createDateTime("deletionRequestedAt", java.time.LocalDateTime.class);
  ...
  public final NumberPath<java.math.BigDecimal> rating =
      createNumber("rating", java.math.BigDecimal.class);

  public final StringPath reviewContent = createString("reviewContent");

  public final EnumPath<liaison.groble.domain.content.enums.ReviewStatus> reviewStatus =
      createEnum("reviewStatus", liaison.groble.domain.content.enums.ReviewStatus.class);
  ...
  public QContentReview(
      Class<? extends ContentReview> type, PathMetadata metadata, PathInits inits) {
