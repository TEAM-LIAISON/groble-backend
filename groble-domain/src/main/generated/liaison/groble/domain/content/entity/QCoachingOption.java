...
public class QCoachingOption extends EntityPathBase<CoachingOption> {
    ...
    public final EnumPath<liaison.groble.domain.content.enums.CoachingPeriod> coachingPeriod = createEnum("coachingPeriod", liaison.groble.domain.content.enums.CoachingPeriod.class);

    public final EnumPath<liaison.groble.domain.content.enums.CoachingType> coachingType = createEnum("coachingType", liaison.groble.domain.content.enums.CoachingType.class);
    ...
    public final EnumPath<liaison.groble.domain.content.enums.DocumentProvision> documentProvision = createEnum("documentProvision", liaison.groble.domain.content.enums.DocumentProvision.class);
