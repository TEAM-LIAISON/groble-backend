...
public class QContent extends EntityPathBase<Content> {
  ...
  public final EnumPath<liaison.groble.domain.content.enums.AdminContentCheckingStatus>
      adminContentCheckingStatus =
          createEnum(
              "adminContentCheckingStatus",
              liaison.groble.domain.content.enums.AdminContentCheckingStatus.class);
  ...
  public final BooleanPath isSearchExposed = createBoolean("isSearchExposed");
  ...
  public final EnumPath<liaison.groble.domain.content.enums.ContentPaymentType> paymentType =
      createEnum("paymentType", liaison.groble.domain.content.enums.ContentPaymentType.class);
  ...
  public final EnumPath<liaison.groble.domain.content.enums.SubscriptionSellStatus>
      subscriptionSellStatus =
          createEnum(
              "subscriptionSellStatus",
              liaison.groble.domain.content.enums.SubscriptionSellStatus.class);
