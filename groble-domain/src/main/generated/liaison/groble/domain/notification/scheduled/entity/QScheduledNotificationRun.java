...
public class QScheduledNotificationRun extends EntityPathBase<ScheduledNotificationRun> {
  ...
  public static final QScheduledNotificationRun scheduledNotificationRun =
      new QScheduledNotificationRun("scheduledNotificationRun");
  ...
  public final DateTimePath<java.time.LocalDateTime> completedAt =
      createDateTime("completedAt", java.time.LocalDateTime.class);
  ...
  public final DateTimePath<java.time.LocalDateTime> executionTime =
      createDateTime("executionTime", java.time.LocalDateTime.class);
  ...
  public final EnumPath<
          liaison.groble.domain.notification.scheduled.enums.ScheduledNotificationRunStatus>
      status =
          createEnum(
              "status",
              liaison.groble.domain.notification.scheduled.enums.ScheduledNotificationRunStatus
  ...
  public QScheduledNotificationRun(
      Class<? extends ScheduledNotificationRun> type, PathMetadata metadata, PathInits inits) {
    super(type, metadata, inits);
    this.scheduledNotification =
        inits.isInitialized("scheduledNotification")
            ? new QScheduledNotification(forProperty("scheduledNotification"))
            : null;
  }
}
