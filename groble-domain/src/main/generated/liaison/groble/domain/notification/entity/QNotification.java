...
public class QNotification extends EntityPathBase<Notification> {
  ...
  public final EnumPath<liaison.groble.domain.notification.enums.NotificationReadStatus>
      notificationReadStatus =
          createEnum(
              "notificationReadStatus",
              liaison.groble.domain.notification.enums.NotificationReadStatus.class);

  public final EnumPath<liaison.groble.domain.notification.enums.NotificationType>
      notificationType =
          createEnum(
              "notificationType", liaison.groble.domain.notification.enums.NotificationType.class);

  public final EnumPath<liaison.groble.domain.notification.enums.SubNotificationType>
      subNotificationType =
          createEnum(
              "subNotificationType",
              liaison.groble.domain.notification.enums.SubNotificationType.class);
