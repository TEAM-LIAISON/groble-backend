...
public class QScheduledNotification extends EntityPathBase<ScheduledNotification> {
    ...
    public final EnumPath<liaison.groble.domain.notification.scheduled.enums.ScheduledNotificationChannel> channel = createEnum("channel", liaison.groble.domain.notification.scheduled.enums.ScheduledNotificationChannel.class);
    ...
    public final ListPath<ScheduledNotificationRun, QScheduledNotificationRun> runs = this.<ScheduledNotificationRun, QScheduledNotificationRun>createList("runs", ScheduledNotificationRun.class, QScheduledNotificationRun.class, PathInits.DIRECT2);
    ...
    public final EnumPath<liaison.groble.domain.notification.scheduled.enums.ScheduledNotificationSendType> sendType = createEnum("sendType", liaison.groble.domain.notification.scheduled.enums.ScheduledNotificationSendType.class);

    public final EnumPath<liaison.groble.domain.notification.scheduled.enums.ScheduledNotificationStatus> status = createEnum("status", liaison.groble.domain.notification.scheduled.enums.ScheduledNotificationStatus.class);
