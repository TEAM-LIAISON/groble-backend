...
public class QTaxInvoice extends EntityPathBase<TaxInvoice> {
    ...
    public final EnumPath<TaxInvoice.InvoiceType> invoiceType = createEnum("invoiceType", TaxInvoice.InvoiceType.class);
    ...
    public QTaxInvoice(Class<? extends TaxInvoice> type, PathMetadata metadata, PathInits inits) {
        ...
        this.settlementItem = inits.isInitialized("settlementItem") ? new QSettlementItem(forProperty("settlementItem"), inits.get("settlementItem")) : null;
    }
