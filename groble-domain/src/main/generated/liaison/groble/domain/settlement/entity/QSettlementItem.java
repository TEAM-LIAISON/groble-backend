...
public class QSettlementItem extends EntityPathBase<SettlementItem> {
  ...
  public final NumberPath<java.math.BigDecimal> capturedPgFeeRate =
      createNumber("capturedPgFeeRate", java.math.BigDecimal.class);

  public final NumberPath<java.math.BigDecimal> capturedPgFeeRateBaseline =
      createNumber("capturedPgFeeRateBaseline", java.math.BigDecimal.class);

  public final NumberPath<java.math.BigDecimal> capturedPgFeeRateDisplay =
      createNumber("capturedPgFeeRateDisplay", java.math.BigDecimal.class);

  public final NumberPath<java.math.BigDecimal> capturedPlatformFeeRate =
      createNumber("capturedPlatformFeeRate", java.math.BigDecimal.class);

  public final NumberPath<java.math.BigDecimal> capturedPlatformFeeRateBaseline =
      createNumber("capturedPlatformFeeRateBaseline", java.math.BigDecimal.class);

  public final NumberPath<java.math.BigDecimal> capturedPlatformFeeRateDisplay =
      createNumber("capturedPlatformFeeRateDisplay", java.math.BigDecimal.class);

  public final NumberPath<java.math.BigDecimal> capturedVatRate =
      createNumber("capturedVatRate", java.math.BigDecimal.class);
  ...
  public final DateTimePath<java.time.LocalDateTime> purchasedAt =
      createDateTime("purchasedAt", java.time.LocalDateTime.class);

  public final StringPath purchaserName = createString("purchaserName");

  public final DateTimePath<java.time.LocalDateTime> refundedAt =
      createDateTime("refundedAt", java.time.LocalDateTime.class);

  public final NumberPath<java.math.BigDecimal> salesAmount =
      createNumber("salesAmount", java.math.BigDecimal.class);
  ...
  public QSettlementItem(
      Class<? extends SettlementItem> type, PathMetadata metadata, PathInits inits) {
    super(type, metadata, inits);
    this.purchase =
        inits.isInitialized("purchase")
            ? new liaison.groble.domain.purchase.entity.QPurchase(
                forProperty("purchase"), inits.get("purchase"))
            : null;
    this.settlement =
