...
public class QFeePolicy extends EntityPathBase<FeePolicy> {
    ...
    public final NumberPath<java.math.BigDecimal> pgFeeRateApplied = createNumber("pgFeeRateApplied", java.math.BigDecimal.class);
    ...
    public final NumberPath<java.math.BigDecimal> platformFeeRateApplied = createNumber("platformFeeRateApplied", java.math.BigDecimal.class);
    ...
    public final EnumPath<liaison.groble.domain.settlement.enums.FeePolicyScope> scopeType = createEnum("scopeType", liaison.groble.domain.settlement.enums.FeePolicyScope.class);
