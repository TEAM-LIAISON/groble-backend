...
public class QSubscription extends EntityPathBase<Subscription> {
  ...
  public final DateTimePath<java.time.LocalDateTime> activatedAt =
      createDateTime("activatedAt", java.time.LocalDateTime.class);

  public final StringPath billingKey = createString("billingKey");

  public final NumberPath<Integer> billingRetryCount =
      createNumber("billingRetryCount", Integer.class);
  ...
  public final DateTimePath<java.time.LocalDateTime> lastBillingAttemptAt =
      createDateTime("lastBillingAttemptAt", java.time.LocalDateTime.class);

  public final DateTimePath<java.time.LocalDateTime> lastBillingSucceededAt =
      createDateTime("lastBillingSucceededAt", java.time.LocalDateTime.class);

  public final DatePath<java.time.LocalDate> nextBillingDate =
      createDate("nextBillingDate", java.time.LocalDate.class);
  ...
  public final EnumPath<liaison.groble.domain.subscription.enums.SubscriptionStatus> status =
      createEnum("status", liaison.groble.domain.subscription.enums.SubscriptionStatus.class);
