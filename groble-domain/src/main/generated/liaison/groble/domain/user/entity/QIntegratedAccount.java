...
public class QIntegratedAccount extends EntityPathBase<IntegratedAccount> {
    ...
    public static final QIntegratedAccount integratedAccount = new QIntegratedAccount("integratedAccount");
    ...
    public QIntegratedAccount(Class<? extends IntegratedAccount> type, PathMetadata metadata, PathInits inits) {
