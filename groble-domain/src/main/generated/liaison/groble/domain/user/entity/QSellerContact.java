...
public class QSellerContact extends EntityPathBase<SellerContact> {
  ...
  public final EnumPath<liaison.groble.domain.user.enums.ContactType> contactType =
      createEnum("contactType", liaison.groble.domain.user.enums.ContactType.class);
  ...
  public QSellerContact(
      Class<? extends SellerContact> type, PathMetadata metadata, PathInits inits) {
