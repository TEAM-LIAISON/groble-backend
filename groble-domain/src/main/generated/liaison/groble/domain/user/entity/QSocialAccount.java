...
public class QSocialAccount extends EntityPathBase<SocialAccount> {
    ...
    public final EnumPath<liaison.groble.domain.user.enums.ProviderType> providerType = createEnum("providerType", liaison.groble.domain.user.enums.ProviderType.class);
