...
public class QUser extends EntityPathBase<User> {
  ...
  public final DateTimePath<java.time.LocalDateTime> refreshTokenExpiresAt =
      createDateTime("refreshTokenExpiresAt", java.time.LocalDateTime.class);

  public final QSocialAccount socialAccount;

  public final SetPath<
          liaison.groble.domain.terms.entity.UserTerms,
          liaison.groble.domain.terms.entity.QUserTerms>
      termsAgreements =
          this
              .<liaison.groble.domain.terms.entity.UserTerms,
                  liaison.groble.domain.terms.entity.QUserTerms>
                  createSet(
                      "termsAgreements",
                      liaison.groble.domain.terms.entity.UserTerms.class,
                      liaison.groble.domain.terms.entity.QUserTerms.class,
                      PathInits.DIRECT2);
  ...
  public final SetPath<
          liaison.groble.domain.role.entity.UserRole, liaison.groble.domain.role.entity.QUserRole>
      userRoles =
          this
              .<liaison.groble.domain.role.entity.UserRole,
                  liaison.groble.domain.role.entity.QUserRole>
                  createSet(
                      "userRoles",
                      liaison.groble.domain.role.entity.UserRole.class,
                      liaison.groble.domain.role.entity.QUserRole.class,
                      PathInits.DIRECT2);
