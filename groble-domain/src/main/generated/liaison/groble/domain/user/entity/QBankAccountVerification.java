...
public class QBankAccountVerification extends EntityPathBase<BankAccountVerification> {
  ...
  public static final QBankAccountVerification bankAccountVerification =
      new QBankAccountVerification("bankAccountVerification");
  ...
  public final NumberPath<java.math.BigDecimal> depositAmount =
      createNumber("depositAmount", java.math.BigDecimal.class);
  ...
  public final EnumPath<liaison.groble.domain.user.enums.BankAccountVerificationStatus> status =
      createEnum("status", liaison.groble.domain.user.enums.BankAccountVerificationStatus.class);

  public final EnumPath<liaison.groble.domain.user.enums.BankAccountVerificationType> type =
      createEnum("type", liaison.groble.domain.user.enums.BankAccountVerificationType.class);
  ...
  public QBankAccountVerification(
      Class<? extends BankAccountVerification> type, PathMetadata metadata, PathInits inits) {
    super(type, metadata, inits);
    this.bankAccount =
        inits.isInitialized("bankAccount")
            ? new QBankAccount(forProperty("bankAccount"), inits.get("bankAccount"))
            : null;
  }
}
