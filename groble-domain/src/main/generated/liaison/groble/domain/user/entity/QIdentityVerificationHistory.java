...
public class QIdentityVerificationHistory extends EntityPathBase<IdentityVerificationHistory> {
    ...
    public final EnumPath<liaison.groble.domain.user.enums.IdentityVerificationStatus> beforeStatus = createEnum("beforeStatus", liaison.groble.domain.user.enums.IdentityVerificationStatus.class);
    ...
    public final EnumPath<liaison.groble.domain.user.vo.IdentityVerification.VerificationMethod> verificationMethod = createEnum("verificationMethod", liaison.groble.domain.user.vo.IdentityVerification.VerificationMethod.class);
    ...
    public QIdentityVerificationHistory(Class<? extends IdentityVerificationHistory> type, PathMetadata metadata, PathInits inits) {
