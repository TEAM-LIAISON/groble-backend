...
public class QSellerInfo extends EntityPathBase<SellerInfo> {
  ...
  public final DateTimePath<java.time.LocalDateTime> makerLastVerificationAttempt =
      createDateTime("makerLastVerificationAttempt", java.time.LocalDateTime.class);
