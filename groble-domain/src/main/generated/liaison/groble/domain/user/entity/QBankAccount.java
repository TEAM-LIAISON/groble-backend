...
public class QBankAccount extends EntityPathBase<BankAccount> {
  ...
  public final EnumPath<liaison.groble.domain.user.enums.BankAccountStatus> status =
      createEnum("status", liaison.groble.domain.user.enums.BankAccountStatus.class);

  public final QUser user;

  public final ListPath<BankAccountVerification, QBankAccountVerification> verifications =
      this.<BankAccountVerification, QBankAccountVerification>createList(
          "verifications",
          BankAccountVerification.class,
          QBankAccountVerification.class,
          PathInits.DIRECT2);
