...
public class QUserWithdrawalHistory extends EntityPathBase<UserWithdrawalHistory> {
    ...
    public static final QUserWithdrawalHistory userWithdrawalHistory = new QUserWithdrawalHistory("userWithdrawalHistory");
    ...
    public final EnumPath<liaison.groble.domain.user.enums.WithdrawalReason> reason = createEnum("reason", liaison.groble.domain.user.enums.WithdrawalReason.class);
