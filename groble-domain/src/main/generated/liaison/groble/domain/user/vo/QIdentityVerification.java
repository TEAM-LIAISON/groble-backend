...
public class QIdentityVerification extends BeanPath<IdentityVerification> {
  ...
  public final EnumPath<liaison.groble.domain.user.enums.IdentityVerificationStatus> status =
      createEnum("status", liaison.groble.domain.user.enums.IdentityVerificationStatus.class);

  public final MapPath<String, Object, SimplePath<Object>> verificationData =
      this.<String, Object, SimplePath<Object>>createMap(
          "verificationData", String.class, Object.class, SimplePath.class);
  ...
  public final DatePath<java.time.LocalDate> verifiedBirthDate =
      createDate("verifiedBirthDate", java.time.LocalDate.class);
