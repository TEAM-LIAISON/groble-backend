...
public class PayplePaymentFacade {
  ...
  public AppCardPayplePaymentResponse processAppCardPayment(
    ...
    return processPaymentInternal(
        ...
        (authInfo, approvalResult) -> transactionService.completePayment(authInfo, approvalResult),
  ...
  private AppCardPayplePaymentResponse processPaymentInternal(
    ...
    try {
      ...
      log.error("{} 페이플 API 호출 실패 - merchantUid: {}", userType, paypleAuthResultDTO.getPayOid(), e);
