...
public class EmailVerificationServiceImpl implements EmailVerificationService {
  ...
  //                (Integer) redisTemplate.opsForValue().get(EMAIL_VERIFY_REQUEST_COUNT_PREFIX +
  // email);
  ...
  //        redisTemplate.opsForValue().set(EMAIL_VERIFIED_PREFIX + verificationId, email,
  // TOKEN_TTL);
  //
  ...
  //        Boolean verified = (Boolean) redisTemplate.opsForValue().get(EMAIL_VERIFIED_PREFIX +
  // email);
  ...
  //        // 인증 ID로 이메일 조회
  //        String email = (String) redisTemplate.opsForValue().get(EMAIL_VERIFIED_PREFIX +
  // verificationId);
  //        if (email == null) {
