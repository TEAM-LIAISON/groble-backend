...
@Component
public class SellerSubscriptionFirstPaymentTemplate implements KakaoTemplate {

  @Value("${bizppurio.templates.seller-subscription-first-payment.code}")
  private String templateCode;

  @Override
  public KakaoNotificationType getType() {
    return KakaoNotificationType.SELLER_SUBSCRIPTION_FIRST_PAYMENT;
  }
  ...
  public String buildMessage(KakaoNotificationDTO dto) {
    return MessageFormatter.sellerSubscriptionFirstPayment(
