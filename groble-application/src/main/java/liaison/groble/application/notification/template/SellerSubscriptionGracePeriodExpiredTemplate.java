...
@Component
public class SellerSubscriptionGracePeriodExpiredTemplate implements KakaoTemplate {

  @Value("${bizppurio.templates.seller-subscription-grace-period-expired.code}")
  private String templateCode;

  @Override
  public KakaoNotificationType getType() {
    return KakaoNotificationType.SELLER_SUBSCRIPTION_GRACE_PERIOD_EXPIRED;
  }
  ...
  public String buildMessage(KakaoNotificationDTO kakaoNotificationDTO) {
    return MessageFormatter.sellerSubscriptionGracePeriodExpired(
