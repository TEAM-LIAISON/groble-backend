...
@Component
public class ReviewRegisteredTemplate implements KakaoTemplate {
  @Value("${bizppurio.templates.review-register.code}")
  private String templateCode;

  @Override
  public KakaoNotificationType getType() {
    return KakaoNotificationType.REVIEW_REGISTERED; // 명확한 타입 지정
  }
