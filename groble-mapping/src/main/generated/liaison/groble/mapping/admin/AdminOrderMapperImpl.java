...
public class AdminOrderMapperImpl implements AdminOrderMapper {
    ...
    @Override
    public AdminOrderCancelRequestResponse toAdminOrderCancelRequestResponse(AdminOrderCancelRequestDTO dto) {
        if ( dto == null ) {
            return null;
        }

        AdminOrderCancelRequestResponse.AdminOrderCancelRequestResponseBuilder adminOrderCancelRequestResponse = AdminOrderCancelRequestResponse.builder();

        return adminOrderCancelRequestResponse.build();
    }

    @Override
    public AdminOrderCancellationReasonResponse toAdminOrderCancellationReasonResponse(AdminOrderCancellationReasonDTO dto) {
        if ( dto == null ) {
            return null;
        }

        AdminOrderCancellationReasonResponse.AdminOrderCancellationReasonResponseBuilder adminOrderCancellationReasonResponse = AdminOrderCancellationReasonResponse.builder();
    ...
    @Override
    public AdminOrderSummaryInfoResponse toAdminOrderSummaryInfoResponse(AdminOrderSummaryInfoDTO dto) {
        if ( dto == null ) {
            return null;
        }

        AdminOrderSummaryInfoResponse.AdminOrderSummaryInfoResponseBuilder adminOrderSummaryInfoResponse = AdminOrderSummaryInfoResponse.builder();
