...
public class AdminMakerMapperImpl implements AdminMakerMapper {
    ...
    @Override
    public AdminMakerDetailInfoResponse toAdminMakerDetailInfoResponse(AdminMakerDetailInfoDTO adminMakerDetailInfoDTO) {
        if ( adminMakerDetailInfoDTO == null ) {
            return null;
        }

        AdminMakerDetailInfoResponse.AdminMakerDetailInfoResponseBuilder adminMakerDetailInfoResponse = AdminMakerDetailInfoResponse.builder();
        ...
        if ( adminMakerDetailInfoDTO.getVerificationStatus() != null ) {
            adminMakerDetailInfoResponse.verificationStatus( adminMakerDetailInfoDTO.getVerificationStatus() );
        }
        ...
        if ( adminMakerDetailInfoDTO.getBankAccountNumber() != null ) {
            adminMakerDetailInfoResponse.bankAccountNumber( adminMakerDetailInfoDTO.getBankAccountNumber() );
        }
        if ( adminMakerDetailInfoDTO.getCopyOfBankBookOriginalFileName() != null ) {
            adminMakerDetailInfoResponse.copyOfBankBookOriginalFileName( adminMakerDetailInfoDTO.getCopyOfBankBookOriginalFileName() );
        }
        if ( adminMakerDetailInfoDTO.getCopyOfBankbookUrl() != null ) {
            adminMakerDetailInfoResponse.copyOfBankbookUrl( adminMakerDetailInfoDTO.getCopyOfBankbookUrl() );
        }
        ...
        if ( adminMakerDetailInfoDTO.getRepresentativeName() != null ) {
            adminMakerDetailInfoResponse.representativeName( adminMakerDetailInfoDTO.getRepresentativeName() );
        }
        ...
        if ( adminMakerDetailInfoDTO.getBusinessLicenseOriginalFileName() != null ) {
            adminMakerDetailInfoResponse.businessLicenseOriginalFileName( adminMakerDetailInfoDTO.getBusinessLicenseOriginalFileName() );
        }
        if ( adminMakerDetailInfoDTO.getBusinessLicenseFileUrl() != null ) {
            adminMakerDetailInfoResponse.businessLicenseFileUrl( adminMakerDetailInfoDTO.getBusinessLicenseFileUrl() );
        }
