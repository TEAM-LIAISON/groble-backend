...
public class AdminContentMapperImpl implements AdminContentMapper {
    ...
    @Override
    public AdminContentSummaryInfoResponse toAdminContentSummaryInfoResponse(AdminContentSummaryInfoDTO adminContentSummaryInfoDTO) {
        if ( adminContentSummaryInfoDTO == null ) {
            return null;
        }

        AdminContentSummaryInfoResponse.AdminContentSummaryInfoResponseBuilder adminContentSummaryInfoResponse = AdminContentSummaryInfoResponse.builder();
        ...
        adminContentSummaryInfoResponse.priceOptionLength( adminContentSummaryInfoDTO.getPriceOptionLength() );
        ...
        if ( adminContentSummaryInfoDTO.getAdminContentCheckingStatus() != null ) {
            adminContentSummaryInfoResponse.adminContentCheckingStatus( adminContentSummaryInfoDTO.getAdminContentCheckingStatus() );
        }
