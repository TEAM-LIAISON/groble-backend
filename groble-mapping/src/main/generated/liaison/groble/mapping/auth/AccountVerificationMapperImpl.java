...
public class AccountVerificationMapperImpl implements AccountVerificationMapper {
  ...
  @Override
  public VerifyBusinessMakerAccountDTO toVerifyBusinessMakerAccountDTO(
      VerificationBusinessMakerAccountRequest request) {
    if (request == null) {
      return null;
    }

    VerifyBusinessMakerAccountDTO.VerifyBusinessMakerAccountDTOBuilder
        verifyBusinessMakerAccountDTO = VerifyBusinessMakerAccountDTO.builder();
