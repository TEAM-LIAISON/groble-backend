...
public class PurchaseMapperImpl implements PurchaseMapper {
    ...
    @Override
    public PurchasedContentDetailResponse toPurchasedContentDetailResponse(PurchasedContentDetailDTO purchasedContentDetailDTO) {
        if ( purchasedContentDetailDTO == null ) {
            return null;
        }

        PurchasedContentDetailResponse.PurchasedContentDetailResponseBuilder purchasedContentDetailResponse = PurchasedContentDetailResponse.builder();
        ...
        if ( purchasedContentDetailDTO.getCancelRequestedAt() != null ) {
            purchasedContentDetailResponse.cancelRequestedAt( purchasedContentDetailDTO.getCancelRequestedAt() );
        }
        ...
        if ( purchasedContentDetailDTO.getSelectedOptionName() != null ) {
            purchasedContentDetailResponse.selectedOptionName( purchasedContentDetailDTO.getSelectedOptionName() );
        }
        if ( purchasedContentDetailDTO.getSelectedOptionQuantity() != null ) {
            purchasedContentDetailResponse.selectedOptionQuantity( purchasedContentDetailDTO.getSelectedOptionQuantity() );
        }
        if ( purchasedContentDetailDTO.getSelectedOptionType() != null ) {
            purchasedContentDetailResponse.selectedOptionType( purchasedContentDetailDTO.getSelectedOptionType() );
        }
        if ( purchasedContentDetailDTO.getDocumentOptionActionUrl() != null ) {
            purchasedContentDetailResponse.documentOptionActionUrl( purchasedContentDetailDTO.getDocumentOptionActionUrl() );
        }
    ...
    @Override
    public PurchaserContentPreviewCardResponse toPurchaserContentPreviewCardResponse(PurchaseContentCardDTO purchaseContentCardDTO) {
        if ( purchaseContentCardDTO == null ) {
            return null;
        }

        PurchaserContentPreviewCardResponse.PurchaserContentPreviewCardResponseBuilder purchaserContentPreviewCardResponse = PurchaserContentPreviewCardResponse.builder();
        ...
        purchaserContentPreviewCardResponse.priceOptionLength( purchaseContentCardDTO.getPriceOptionLength() );
