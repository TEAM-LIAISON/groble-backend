...
public class MarketMapperImpl implements MarketMapper {
    ...
    @Override
    public PageResponse<ContentPreviewCardResponse> toContentPreviewCardResponsePage(PageResponse<ContentCardDTO> dtoPageResponse) {
        if ( dtoPageResponse == null ) {
            return null;
        }

        PageResponse<ContentPreviewCardResponse> pageResponse = new PageResponse<ContentPreviewCardResponse>();

        if ( pageResponse.getItems() != null ) {
            List<ContentPreviewCardResponse> list = toContentPreviewCardResponseList( dtoPageResponse.getItems() );
            if ( list != null ) {
