...
public class PaymentMapperImpl implements PaymentMapper {
    ...
    @Override
    public PaypleAuthResultDTO toPaypleAuthResultDTO(PaypleAuthResultRequest paypleAuthResultRequest) {
        if ( paypleAuthResultRequest == null ) {
            return null;
        }

        PaypleAuthResultDTO.PaypleAuthResultDTOBuilder paypleAuthResultDTO = PaypleAuthResultDTO.builder();
    ...
    @Override
    public PaymentCancelInfoResponse toPaymentCancelInfoResponse(PaymentCancelInfoDTO paymentCancelInfoDTO) {
        if ( paymentCancelInfoDTO == null ) {
            return null;
        }

        PaymentCancelInfoResponse.PaymentCancelInfoResponseBuilder paymentCancelInfoResponse = PaymentCancelInfoResponse.builder();
