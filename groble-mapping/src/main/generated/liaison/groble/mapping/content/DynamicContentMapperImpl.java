...
public class DynamicContentMapperImpl implements DynamicContentMapper {
    ...
    public DynamicContentResponse toDynamicContentResponse(DynamicContentDTO dynamicContentDTO) {
        ...
        DynamicContentResponse.DynamicContentResponseBuilder dynamicContentResponse = DynamicContentResponse.builder();
    ...
    @Override
    public List<DynamicContentResponse> toDynamicContentResponseList(List<DynamicContentDTO> dynamicContentDTOs) {
        if ( dynamicContentDTOs == null ) {
            return null;
        }

        List<DynamicContentResponse> list = new ArrayList<DynamicContentResponse>( dynamicContentDTOs.size() );
