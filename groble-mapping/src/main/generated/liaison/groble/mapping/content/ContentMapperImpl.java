...
public class ContentMapperImpl implements ContentMapper {
    ...
    public ContentStatusResponse toContentStatusResponse(ContentDTO contentDTO) {
        ...
        ContentStatusResponse.ContentStatusResponseBuilder contentStatusResponse = ContentStatusResponse.builder();
    ...
    @Override
    public ContentDetailResponse toContentDetailResponse(ContentDetailDTO contentDetailDTO, ContactInfoResponse contactInfoResponse) {
        if ( contentDetailDTO == null && contactInfoResponse == null ) {
            return null;
        }

        ContentDetailResponse.ContentDetailResponseBuilder contentDetailResponse = ContentDetailResponse.builder();
        ...
        contentDetailResponse.priceOptionLength( contentDetailDTO.getOptions() != null ? contentDetailDTO.getOptions().size() : 0 );
