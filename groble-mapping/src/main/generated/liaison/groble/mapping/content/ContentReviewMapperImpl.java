...
public class ContentReviewMapperImpl implements ContentReviewMapper {
    ...
    public ContentReviewResponse toContentReviewResponse(ContentReviewDTO contentReviewDTO) {
        ...
        ContentReviewResponse.ContentReviewResponseBuilder contentReviewResponse = ContentReviewResponse.builder();
        ...
        List<ContentDetailReviewResponse> list = contentDetailReviewDTOListToContentDetailReviewResponseList( contentReviewDTO.getReviews() );
        if ( list != null ) {
    ...
    @Override
    public ContentDetailReviewResponse toContentDetailReviewResponse(ContentDetailReviewDTO contentDetailReviewDTO) {
        if ( contentDetailReviewDTO == null ) {
            return null;
        }

        ContentDetailReviewResponse.ContentDetailReviewResponseBuilder contentDetailReviewResponse = ContentDetailReviewResponse.builder();
        ...
        if ( contentDetailReviewDTO.getReviewerProfileImageUrl() != null ) {
            contentDetailReviewResponse.reviewerProfileImageUrl( contentDetailReviewDTO.getReviewerProfileImageUrl() );
        }
        ...
        if ( contentDetailReviewDTO.getSelectedOptionName() != null ) {
            contentDetailReviewResponse.selectedOptionName( contentDetailReviewDTO.getSelectedOptionName() );
        }
        ...
        List<ReviewReplyResponse> list = reviewReplyDTOListToReviewReplyResponseList( contentDetailReviewDTO.getReviewReplies() );
        if ( list != null ) {
    ...
    protected List<ContentDetailReviewResponse> contentDetailReviewDTOListToContentDetailReviewResponseList(List<ContentDetailReviewDTO> list) {
        if ( list == null ) {
            return null;
        }

        List<ContentDetailReviewResponse> list1 = new ArrayList<ContentDetailReviewResponse>( list.size() );
    ...
    protected ReviewReplyResponse reviewReplyDTOToReviewReplyResponse(ReviewReplyDTO reviewReplyDTO) {
        ...
        ReviewReplyResponse.ReviewReplyResponseBuilder reviewReplyResponse = ReviewReplyResponse.builder();
    ...
    protected List<ReviewReplyResponse> reviewReplyDTOListToReviewReplyResponseList(List<ReviewReplyDTO> list) {
        if ( list == null ) {
            return null;
        }
