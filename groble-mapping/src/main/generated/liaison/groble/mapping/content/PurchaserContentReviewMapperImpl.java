...
@Generated(
    ...
    date = "2025-08-27T18:38:52+0900",
    comments = "version: 1.5.5.Final, compiler: javac, environment: Java 17.0.10 (Amazon.com Inc.)")
@Component
public class PurchaserContentReviewMapperImpl implements PurchaserContentReviewMapper {

  @Override
  public PurchaserContentReviewDTO toPurchaserContentReviewDTO(
      PurchaserContentReviewRequest purchaserContentReviewRequest) {
    if (purchaserContentReviewRequest == null) {
      return null;
    }

    PurchaserContentReviewDTO.PurchaserContentReviewDTOBuilder purchaserContentReviewDTO =
        PurchaserContentReviewDTO.builder();
  ...
  @Override
  public PurchaserContentReviewResponse toPurchaserContentReviewResponse(
      PurchaserContentReviewDTO purchaserContentReviewDTO) {
    if (purchaserContentReviewDTO == null) {
      return null;
    }

    PurchaserContentReviewResponse.PurchaserContentReviewResponseBuilder
        purchaserContentReviewResponse = PurchaserContentReviewResponse.builder();
