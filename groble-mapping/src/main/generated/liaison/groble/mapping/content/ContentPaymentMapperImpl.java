...
public class ContentPaymentMapperImpl implements ContentPaymentMapper {
    ...
    public ContentPayPageResponse toContentPayPageResponse(ContentPayPageDTO contentPayPageDTO) {
        ...
        ContentPayPageResponse.ContentPayPageResponseBuilder contentPayPageResponse = ContentPayPageResponse.builder();
        ...
        List<UserCouponResponse> list = userCouponDTOListToUserCouponResponseList( contentPayPageDTO.getUserCoupons() );
        if ( list != null ) {
    ...
    protected UserCouponResponse userCouponDTOToUserCouponResponse(ContentPayPageDTO.UserCouponDTO userCouponDTO) {
    ...
    protected List<UserCouponResponse> userCouponDTOListToUserCouponResponseList(List<ContentPayPageDTO.UserCouponDTO> list) {
        if ( list == null ) {
            return null;
        }
