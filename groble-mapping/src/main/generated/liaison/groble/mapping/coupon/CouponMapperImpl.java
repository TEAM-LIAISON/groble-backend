...
public class CouponMapperImpl implements CouponMapper {
    ...
    @Override
    public List<UserCouponResponse> toUserCouponResponseList(List<UserCouponResponseDTO> userCouponResponseDTOs) {
        if ( userCouponResponseDTOs == null ) {
            return null;
        }

        List<UserCouponResponse> list = new ArrayList<UserCouponResponse>( userCouponResponseDTOs.size() );
    ...
    protected UserCouponResponse userCouponResponseDTOToUserCouponResponse(UserCouponResponseDTO userCouponResponseDTO) {
