...
public class UserMapperImpl implements UserMapper {
    ...
    @Override
    public BuyerMyPageSummaryResponse toBuyerSummaryResponse(UserMyPageSummaryDTO userMyPageSummaryDTO) {
        if ( userMyPageSummaryDTO == null ) {
            return null;
        }

        BuyerMyPageSummaryResponse.BuyerMyPageSummaryResponseBuilder buyerMyPageSummaryResponse = BuyerMyPageSummaryResponse.builder();
        ...
        buyerMyPageSummaryResponse.alreadyRegisteredAsSeller( userMyPageSummaryDTO.isAlreadyRegisteredAsSeller() );
    ...
    @Override
    public SellerMyPageSummaryResponse toSellerSummaryResponse(UserMyPageSummaryDTO userMyPageSummaryDTO) {
        if ( userMyPageSummaryDTO == null ) {
            return null;
        }

        SellerMyPageSummaryResponse.SellerMyPageSummaryResponseBuilder sellerMyPageSummaryResponse = SellerMyPageSummaryResponse.builder();
        ...
        if ( userMyPageSummaryDTO.getVerificationStatusName() != null ) {
            sellerMyPageSummaryResponse.verificationStatus( userMyPageSummaryDTO.getVerificationStatusName() );
        }
        sellerMyPageSummaryResponse.alreadyRegisteredAsSeller( userMyPageSummaryDTO.isAlreadyRegisteredAsSeller() );
        if ( userMyPageSummaryDTO.getNickname() != null ) {
    ...
    @Override
    public UserMyPageDetailResponse toApiMyPageDetailResponse(UserMyPageDetailDTO userMyPageDetailDTO) {
        if ( userMyPageDetailDTO == null ) {
            return null;
        }

        UserMyPageDetailResponse.UserMyPageDetailResponseBuilder userMyPageDetailResponse = UserMyPageDetailResponse.builder();
        ...
        userMyPageDetailResponse.sellerAccountNotCreated( userMyPageDetailDTO.isSellerAccountNotCreated() );
        ...
        userMyPageDetailResponse.alreadyRegisteredAsSeller( userMyPageDetailDTO.isAlreadyRegisteredAsSeller() );
