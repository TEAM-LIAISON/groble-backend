...
public class NotificationMapperImpl implements NotificationMapper {
    ...
    @Override
    public NotificationDetailsResponse toNotificationDetailsResponse(NotificationDetailsDTO notificationDetailsDTO) {
        if ( notificationDetailsDTO == null ) {
            return null;
        }

        NotificationDetailsResponse.NotificationDetailsResponseBuilder notificationDetailsResponse = NotificationDetailsResponse.builder();
    ...
    @Override
    public NotificationItemResponse toNotificationItemResponse(NotificationItemDTO notificationItemDTO) {
        if ( notificationItemDTO == null ) {
            return null;
        }

        NotificationItemResponse.NotificationItemResponseBuilder notificationItemResponse = NotificationItemResponse.builder();
        ...
        if ( notificationItemDTO.getNotificationReadStatus() != null ) {
            notificationItemResponse.notificationReadStatus( notificationItemDTO.getNotificationReadStatus() );
        }
        if ( notificationItemDTO.getNotificationOccurTime() != null ) {
            notificationItemResponse.notificationOccurTime( notificationItemDTO.getNotificationOccurTime() );
        }
        if ( notificationItemDTO.getNotificationDetails() != null ) {
            notificationItemResponse.notificationDetails( toNotificationDetailsResponse( notificationItemDTO.getNotificationDetails() ) );
        }
    ...
    @Override
    public List<NotificationItemResponse> toNotificationItemResponseList(List<NotificationItemDTO> notificationItemDTOs) {
        if ( notificationItemDTOs == null ) {
            return null;
        }

        List<NotificationItemResponse> list = new ArrayList<NotificationItemResponse>( notificationItemDTOs.size() );
    ...
    @Override
    public NotificationItemsResponse toNotificationItemsResponse(NotificationItemsDTO notificationItemsDTO) {
        if ( notificationItemsDTO == null ) {
            return null;
        }

        NotificationItemsResponse.NotificationItemsResponseBuilder notificationItemsResponse = NotificationItemsResponse.builder();

        List<NotificationItemResponse> list = toNotificationItemResponseList( notificationItemsDTO.getNotificationItems() );
        if ( list != null ) {
