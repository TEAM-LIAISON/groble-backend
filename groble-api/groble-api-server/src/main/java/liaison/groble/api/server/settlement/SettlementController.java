...
public class SettlementController {
  ...
  private static final String SETTLEMENT_DETAIL_PATH = "/settlements/{year}/{month}";
  ...
  //    @Operation(summary = "[💰 정산] 정산 상세 내역 조회", description = "월별 정산 상세 내역 조회, 세금계산서 다운로드 가능 여부를
  // 조회합니다.")
  //    @GetMapping(SETTLEMENT_DETAIL_PATH)
  //    public ResponseEntity<GrobleResponse<Void>> getSettlementDetail(
  //            @Auth Accessor accessor
  //    ) {
  //
  //    }
