...
public final class GenericResponseSchemas {
  ...
  @Schema(description = CommonSwaggerDocs.GROBLE_RESPONSE_DESC + " - 정산 승인 응답")
  public static class ApiSettlementApprovalResponse {
    ...
    @Schema(description = "응답 메시지", example = ResponseMessages.Admin.SETTLEMENT_APPROVAL_SUCCESS)
    public String message;

    @Schema(description = "정산 승인 결과 데이터")
    public SettlementApprovalResponse data;
