...
@Operation(summary = "콘텐츠 심사 요청", description = "콘텐츠 심사를 요청합니다. 콘텐츠 유형(코칭/문서)에 따라 옵션 구조가 달라집니다.")
@ApiResponses({
  @ApiResponse(
      responseCode = "200",
      description = "콘텐츠 심사 요청 성공",
      content =
          @Content(
              mediaType = "application/json",
              schema = @Schema(implementation = ContentRegisterApiResponse.class),
              examples = {
                @ExampleObject(
                    name = "코칭 콘텐츠 심사 요청 응답",
                    summary = "코칭 유형 콘텐츠 심사 요청 성공",
                    value =
                        """
                                                {
                                                  "status": "SUCCESS",
                                                ...
                                                """),
                @ExampleObject(
                    name = "문서 콘텐츠 심사 요청 응답",
                    summary = "문서 유형 콘텐츠 심사 요청 성공",
                    value =
                        """
                                                {
                                                  "status": "SUCCESS",
