...
@NoArgsConstructor
@AllArgsConstructor
@Schema(description = "정기결제 해지 요청 DTO")
public class SubscriptionCancelRequest {

  @NotNull(message = "정기결제 해지 사유는 필수 선택 항목입니다.")
  @Schema(
      description = "정기결제 해지 사유를 선택해주세요.",
  ...
  @Schema(
      description = "정기결제 해지 상세 사유를 작성해주세요. (선택 항목)",
      example = "더 이상 이용하지 않습니다.",
      type = "string",
